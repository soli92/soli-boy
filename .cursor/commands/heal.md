...
> **Adapter Cursor** del comando `/heal`. Ripara ERROR meccanici flaggati `heal-eligible` da un lint report. Loop evaluator-optimizer vincolato, gated, max 3 iterazioni.
> Invocazione: `/heal <args>` (Cursor custom command).
