...
> **Adapter Cursor** del comando `/review`. Invoca il code-reviewer su un TSK (PATTERN §19, v2.12). Esegue code-review-protocol 5 fasi e ritorna verdict pass | conditional | reject. Loop bounded da code_quality.max_iterations.
> Invocazione: `/review <args>` (Cursor custom command).
