...
> **Adapter Cursor** del comando `/query`. Risponde a una domanda NL leggendo solo wiki/. Flag --ephemeral per non salvare.
> Invocazione: `/query <args>` (Cursor custom command).
